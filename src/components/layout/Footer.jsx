        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:dgboadservices@gmail.com" className="hover:text-brand-gold transition-colors">
...
//               <a href="https://maps.app.goo.gl/9s3sUc8nf2hT5NiG8" className="hover:text-brand-gold transition-colors"></a>
